...
const TRADITIONAL_TO_SIMPLIFIED = {
  ...
  '限時優惠進行中':'限时优惠进行中','首次':'首次','消費':'消费','享':'享','折':'折','加入':'加入','了解更多':'了解更多','精選':'精选','嚴選食材':'严选食材','匠心烹製':'匠心烹制','全部':'全部','主廚推薦':'主厨推荐','前菜':'前菜','湯':'汤','煲':'煲','飯類':'饭类','麵類':'面类','湯麵':'汤面','海鮮':'海鲜','牛肉':'牛肉','雞肉':'鸡肉','燒臘':'烧腊','蔬菜':'蔬菜','豬肉':'猪肉','飲料':'饮料','加入購物車':'加入购物车',
  '廣東菜':'广东菜','餐廳':'餐厅','燒臘':'烧腊','熱炒':'热炒','湯品':'汤品','延續':'延续','粵菜':'粤菜','講究':'讲究','鮮':'鲜','開業':'开业','兩年':'两年','有餘':'有余','持續':'持续','真誠':'真诚','接待':'接待','客人':'客人','現已':'现已','約':'约','道菜色':'道菜色','累積':'累计','數千位':'数千位','個月營運':'个月运营','道料理':'道料理','位顧客':'位顾客',
  ...
  '我們的故事':'我们的故事','用心料理':'用心料理','用愛服務':'用爱服务','特色':'特色','結合':'结合','適合':'适合','家庭':'家庭','朋友':'朋友','聚餐':'聚餐','豐富':'丰富','以來':'以来','始終':'始终','秉持':'秉持','待客':'待客','精神':'精神','精進':'精进','每位':'每位','來訪':'来访','感受到':'感受到','溫暖':'温暖','地道':'地道','風味':'风味','我們的理念':'我们的理念','當季':'当季','减少':'减少','不必要':'不必要','添加物':'添加物','品嚐':'品尝','純粹':'纯粹','美味':'美味','用餐環境':'用餐环境','餐廳位置':'餐厅位置',
